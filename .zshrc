...
export PATH="/bin:/sbin:/usr/bin:/usr/sbin:/usr/local/bin:/usr/local/sbin:/usr/games:/ usr / bin / core_perl:$HOME/.local/bin:$HOME/.cabal/bin"
export PAGER="less"
export EDITOR="vim"
...
export PS1="%{$fg[white]%}┌─[%{$fg[green]%}%n  %{$fg[cyan]%}$SHELL  %{$fg_bold[blue]%}%l %{$fg[red]%}%? %{$fg_bold[blue]%}%h%b  %{$fg[green]%}%d%{$fg[white]%}] %{$fg[cyan]%}%*%{$reset_color%}"$'\n'"%{$fg[white]%}└─> %{$reset_color%}"
