...
Config {
       ...
       , commands         = [
                            ...
                            , Run Com        "XMTrans" [] "" 100
                            , Run DynNetwork ["-S","True","-d","2","-t","<fc=#95d5f5><dev>:</fc><fn=2> </fn><rx><fn=2> </fn><fc=#00ff00>↓</fc><fc=#ff6500>↑</fc><fn=2> </fn><tx>"] 10
                            , Run Com        "XMTraf" [] "" 50
                            , Run MultiCpu   ["-S","True","-t","<fc=#95d5f5>CPU:</fc><fn=2> </fn><total>","-L","33","-H","66","-n","#ffff00","-h","#ff6500"] 10
                            , Run Com        "XMTCpu" [] "" 10
                            , Run Com        "XMTMB" [] "" 10
                            , Run Com        "XMTGpu" [] "" 10
                            , Run Memory     ["-S","True","-t","<fc=#95d5f5>RAM:</fc><fn=2> </fn><usedratio>","-L","75","-H","90","-n","#ffff00","-h","#ff6500"] 50
