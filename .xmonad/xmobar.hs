...
Config {
       ...
       , commands         = [
                            ...
                            , Run PipeReader         "/tmp/haron/CC"    "CC"    -- Symbol C
                            ...
                            , Run PipeReader         "/tmp/haron/TR"    "TR"    -- Daily traffic
                            , Run PipeReader         "/tmp/haron/CU"    "CU"    -- CPU load
                            , Run PipeReader         "/tmp/haron/TEMP"  "TEMP"  -- Temperature of all devices
