...
Config {
       ...
       , commands         = [
                            ...
                            , Run PipeReader         "/tmp/haron/animation"    "AP"
                            , Run Kbd                [
                                                       ("us", "<fc=#ccc></fc>")
                                                     , ("ru", "<fc=#f60></fc>")
                                                     ]
