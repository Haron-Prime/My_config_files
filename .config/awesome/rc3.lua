...
for s = 1, screen.count() do
    ...
    tags[s] = awful.tag({ "Web", "Mail", "Editor", "Files", "System", "Video", "Pictures", "Work", "Torrents" }, s, {layouts[1], layouts[1], layouts[4], layouts[10], layouts[10], layouts[9], layouts[8], layouts[10], layouts[10]})
end
-- }}}
...
globalkeys = awful.util.table.join(
    ...
    awful.key({                   }, "XF86Mail",             function () awful.util.spawn_with_shell("/home/haron/.local/bin/thunderbird")                   end),
